...
const CREATE_INPUT = {
  ...
  fromWalletId: "exampleFromWalletId",
  id: "exampleId",
  toWallet: "exampleToWallet",
  toWalletId: "exampleToWalletId",
  ...
  test("POST /transactions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        transactionCreatedAt: CREATE_RESULT.transactionCreatedAt.toISOString(),
      ...
      .expect([
        {
          ...
          transactionCreatedAt:
            FIND_MANY_RESULT[0].transactionCreatedAt.toISOString(),
  ...
  test("GET /transactions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        transactionCreatedAt:
          FIND_ONE_RESULT.transactionCreatedAt.toISOString(),
